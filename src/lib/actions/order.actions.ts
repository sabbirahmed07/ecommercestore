...
export async function createOrder() {
  try {
    ...
    if (!insertedOrderId) throw new Error('The order not created');
...
export async function updateOrderToPaid({
  ...
  //transaction to update and account product stock
  ...
  //get updated order after after transaction
